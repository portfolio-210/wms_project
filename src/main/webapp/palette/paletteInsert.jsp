    ...
    <div class="mb-3" style="position: relative;">
        <ul class="ul-2">
            ...
            <li style="display: flex; flex-direction: row;">
                <input type="text" style="width: 200px; height: 40px;" class="form-control font12" placeholder="파렛트명을 입력하세요">
            ...
            <li style="display: flex; flex-direction: row;">
                <input type="text" style="width: 100px; height: 40px;" class="form-control font12" maxlength="5"><font style="font-size: 12px; color: red;">&nbsp;&nbsp;※ 파렛트 코드는 최대 5개의 코드로 사용합니다.</font>
            </li>
        </ul>
     </div>
     <div>
